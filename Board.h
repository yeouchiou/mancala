...
public:
	...
	// this function returns false without changing anything.Otherwise, it will return true after sowing the beans
	...
	// different rules about these issues, so dealing with them should not be the responsibility 
	// of the Board class.) 
